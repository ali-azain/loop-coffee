    ...
    <>
      ...
      <nav className="hidden md:block">
        ...
        <div className="hidden md:block fixed top-12 left-1/2 -translate-x-1/2 z-50 overflow-hidden mix-blend-multiply">
          ...
          >
            <img src={`${import.meta.env.BASE_URL}logo.png`} alt="Loop" className="h-8 w-auto" />
          </motion.a>
        </div>
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            >
              <img src={`${import.meta.env.BASE_URL}logo.png`} alt="Loop" className="h-6 w-auto mix-blend-multiply opacity-50" />
            </motion.div>
